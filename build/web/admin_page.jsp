                ...
                <div class="filter-v1 margin-top-10">
                    ...
                    <div class="row mix-grid thumbnails">
                        <div class="col-md-4 col-sm-6 mix category_1">
                            <div class="mix-inner">
                                <img class="img-responsive" src="theme/assets/admin/layout/img/phase1.jpg" alt="">
                                <div class="mix-details">
                                    <h3 align="center">Preparation</h3>
                                    <p>
                        ...
                        <div class="col-md-4 col-sm-6 mix category_2">
                            <div class="mix-inner">
                                <img class="img-responsive" src="theme/assets/admin/layout/img/phase2.jpg" alt="">
                                <div class="mix-details">
                                    <h3 align="center">Generation</h3>
                                    <p>
                        ...
                        <div class="col-md-4 col-sm-6 mix category_3">
                            <div class="mix-inner">
                                <img class="img-responsive" src="theme/assets/admin/layout/img/phase3.jpg" alt="">
                                
                                <div class="mix-details">
                                    <h3 align="center">Adjustment</h3>
                                    <p>
