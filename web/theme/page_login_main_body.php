...
<div class="logo">
	<a href="index.html">
	<img src="<?php echo URL ?>/theme/assets/admin/layout/img/logo-big.png" alt=""/>
	</a>
</div>
<!-- END LOGO -->
...
<div class="content">
	<!-- BEGIN LOGIN FORM -->
        ...
        if(isset($_SESSION['system_msg']) && isset($_SESSION['system_msg_colour'])){
            $tempSystemMessage = $_SESSION['system_msg'];
            $tempSystemMessageColour = $_SESSION['system_msg_colour'];
            
            //print "ERROR_MESSAGE: " . $tempSystemMessage ;
            //print "ERROR_COLOUR: " . $tempSystemMessageColour ;
            print "<font color='". $tempSystemMessageColour . "'>"  . $tempSystemMessage . "</font>";
            
            unset($_SESSION['system_msg']);
            unset($_SESSION['system_msg_coiour']);
        }
        ?>
	<form class="login-form" action="<?php echo URL ?>/lib/controller/LoginController.php" method="post">
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="UserID" name="user_id"/>
			</div>
		</div>
		<div class="form-group">
...
<script src="<?php echo URL ?>/theme/assets/global/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript"></script>
...
<script src="<?php echo URL ?>/theme/assets/admin/pages/scripts/login.js" type="text/javascript"></script>
